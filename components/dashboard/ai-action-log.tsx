                ...
                <div className="flex items-start sm:items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                      <span className="text-white/40">[{new Date(action.created_at).toLocaleTimeString(language === "tr" ? "tr-TR" : language === "de" ? "de-DE" : language === "sv" ? "sv-SE" : language === "es" ? "es-ES" : language === "el" ? "el-GR" : language === "ru" ? "ru-RU" : "en-US", { hour12: false })}]</span>
