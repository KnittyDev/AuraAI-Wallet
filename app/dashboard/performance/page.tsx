...
export default function PerformancePage() {
  ...
  let startingBalanceForRange = totalInvested + actionsBeforeRange.reduce((acc, a) => acc + Number(a.profit_usd || 0), 0);
    ...
    const performanceHistory = filteredActions.map(a => {
      ...
      return {
        date: new Date(a.created_at).toLocaleDateString(language === "tr" ? "tr-TR" : language === "de" ? "de-DE" : language === "sv" ? "sv-SE" : language === "es" ? "es-ES" : language === "el" ? "el-GR" : language === "ru" ? "ru-RU" : "en-US", 
          timeRange === "24H" 
    ...
    filteredActions.forEach(a => {
      const month = new Date(a.created_at).toLocaleDateString(language === "tr" ? "tr-TR" : language === "de" ? "de-DE" : language === "sv" ? "sv-SE" : language === "es" ? "es-ES" : language === "el" ? "el-GR" : language === "ru" ? "ru-RU" : "en-US", { month: 'short' });
