                    ...
                    {!depositData ? (
                      <div className="w-full max-w-md space-y-6">
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-white/60">Amount in USD (Whole Numbers Only)</label>
                          <div className="relative group">
                            ...
                            <div className="relative flex items-center px-4 py-1 rounded-2xl border border-white/20 bg-black/60 backdrop-blur-md">
                              ...
                              <input
                                ...
                                value={amount}
                                onChange={(e) => {
                                  // Restrict to positive whole numbers only
                          ...
                          <div className="flex justify-between items-center px-2 mb-2">
                            ...
                            <p className="text-sm font-bold text-white">
                              {(() => {
                                ...
                                // For BTC, ETH, SOL: show the exact amount one-to-one
                                return depositData.expectedAmount;
                              })()}{" "}
                              {(() => {
                                if (selectedAsset.code === "USDT") {
                                  if (selectedNetwork.id === "trc20") return "USDT (TRC 20)";
                                  if (selectedNetwork.id === "erc20") return "USDT (ERC 20)";
                                  if (selectedNetwork.id === "bep20") return "USDT (BEP 20)";
                                  return "USDT";
                                }
